    ...
    <div className="flex flex-col min-h-screen">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem className="hidden md:block">
              <BreadcrumbLink href="/admin/permissions">Admin</BreadcrumbLink>
            </BreadcrumbItem>
      ...
      <main className="flex-1 container max-w-6xl mx-auto p-4">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Manage user and group permissions for accessing tool groups.</p>
        </div>
        <PermissionManager />
      </main>
    </div>
